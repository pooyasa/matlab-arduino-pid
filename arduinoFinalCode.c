 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Jan 23 14:10:56 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME arduinoFinalCode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    real_T *xAngle = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    arduinoFinalCode_Outputs_wrapper(xAngle, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    arduinoFinalCode_Update_wrapper(xAngle, xD);
