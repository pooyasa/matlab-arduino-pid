###########################################################################
## Makefile generated for Simulink model 'finalBlock'. 
## 
## Makefile     : finalBlock.mk
## Generated on : Thu Jan 23 12:55:13 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/finalBlock.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = F:/Coding/ControlProjects/ArmFinalCopy
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = finalBlock_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/finalBlock.elf
...
DEFINES_STANDARD = -DMODEL=finalBlock -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/finalBlock_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/finalBlock_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/finalBlock_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
